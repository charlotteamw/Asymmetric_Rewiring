...
eq_P = Plots.plot(eq_hold[:,1], eq_hold[:,6], legend = false, grid = false, lw = 5.0, color = "black", xlabel = "K1", ylabel = "Predator Equ. Density", xflip = true)
...
pred_prod_plot = Plots.plot(pred_prod_hold[:, 1], pred_prod_hold[:, 2], legend = false, grid = false, lw = 5.0, color = "black", xlabel = "K1", ylabel = "Predator Production", xflip = true)
...
basal_prod_plot = Plots.plot(basal_prod_hold[:, 1], basal_prod_hold[:, 2], legend = false, grid = false, lw = 5.0, color = "black", xlabel = "K1", ylabel = "Primary Production", xflip = true)
...
int_prod_plot = Plots.plot(int_prod_hold[:, 1], int_prod_hold[:, 2],legend = false, grid = false, lw = 5.0, color = "black", xlabel = "K1", ylabel = "Intermediate Production", xflip = true)
